...
export const MANAGED_KEYS: KeyMeta[] = [
  ...
  { key: "GEMINI_IMAGE_MODEL", label: "Gemini image model", group: "AI", secret: false, envValue: () => env.geminiImageModel, help: "Used for proposal hero images. Same Gemini key, different model." },
