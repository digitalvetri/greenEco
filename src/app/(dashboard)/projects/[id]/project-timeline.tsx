import { PlusCircle, CheckCircle2, FileText, IndianRupee, Flag, MessageSquare, type LucideIcon } from "lucide-react";
import { Card } from "@/components/ui/card";
import type { ProjectEvent } from "@/server/services/order";

const ICON: Record<ProjectEvent["kind"], LucideIcon> = {
  created: PlusCircle,
  stage: CheckCircle2,
  drawing: FileText,
  payment: IndianRupee,
...
/** Project execution timeline — stages, drawings, payments, status. Two-column rail. */
